<x-admin-layout title="Usuarios" :breadcrumbs="[
    ...
    <x-wire-card>
        ...
        <div class="space-y-4">
            ...
            <x-wire-input label="Correo" name="email" type="email" placeholder="ejemplo@dominio.com" required automcomplete="email"
            :value="old('email', $user->email)"></x-wire-input>

            <x-wire-input label="Contraseña" name="password" type="password" placeholder="Mínimo 8 caracteres" 
            autocomplete="new-password"></x-wire-input>

            <x-wire-input label="Confirmar contraseña" name="password_confirmation" type="password" placeholder="Repite la contraseña"
            autocomplete="new-password"></x-wire-input>
            ...
            <x-wire-input label="Télefono" name="phone" placeholder="Ej. 9911099943" autocomplete="tel" required inputmode="tel" :value="old('phone', $user->phone)"></x-wire-input>
            </div>
